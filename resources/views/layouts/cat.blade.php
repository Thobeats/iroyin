            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    ...
                    <ul class="navbar-nav mr-auto mt-lg-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('news', ['category' => 'business', 'country' => 'ng']) }}">Business </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('news', ['category' => 'health', 'country' => 'ng']) }}">Health</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('news', ['category' => 'entertainment', 'country' => 'ng']) }}">Entertainment</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('news', ['category' => 'sports', 'country' => 'ng']) }}">Sports</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('news', ['category' => 'technology', 'country' => 'ng']) }}">Technology</a>
                        </li>
