...
@section('big_card')
    <section class="mt-3">
        <div class="card-body d-flex flex-row big_card" style="background-image:linear-gradient(to bottom, rgba(0, 0, 0, 0.264), rgba(0, 0, 0, 0.264), rgba(0, 0, 0, 1)), url({{ $big_card->urlToImage != '' ? $big_card->urlToImage : '/img/noimgiroyin.png' }});">
...
@section('cards')
    ...
    <section class="mt-3 col-lg-12 col-md-6 col-sm-12">
        <div class="card-body d-flex flex-row topcard" style="background-image:linear-gradient(to bottom, rgba(0, 0, 0, 0.464), rgba(0, 0, 0, 1)), url('{{ $card->urlToImage != '' ? $card->urlToImage : '/img/noimgiroyin.png' }}');">
           <div class="align-self-end p-2">
...
@foreach($rests as $bus)
    <div class='col-md-4 mt-3'>
      <div class="card-body restcard" style="background-image:url( '{{ $bus->urlToImage != '' ? $bus->urlToImage : '/img/noimgiroyin.png'  }}');">
